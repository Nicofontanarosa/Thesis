...
| File | Description |
|------|--------------|
| **final_output.json** | Contains all analyzed flows processed by the tool, including metadata and classification results. |
...
| **flows.txt** | Provides summary information about the flows analyzed (IDs, ports, protocols, etc.). |
| **stats.txt** | Includes general statistics about the analyzed traffic (flow count, protocol distribution, etc.). |
