...
def run_coverage_tests():
    ...
    log_base_path = r"coverage\coverageGT"
    group_path = r".\gt"
    ...
    for app in applications:
        ...
        groups_file = os.path.join(group_path, f"{app}.json")
        ...
        # Calcola la coverage
        coverage_result = coverage.calculate_coverage("tmp/final_complete_output.json", groups_file)
